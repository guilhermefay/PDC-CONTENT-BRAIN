...
# Se rodar de dentro de /api, pode precisar de 'from ..infra.r2r_client import R2RClientWrapper'
...
async def query_documents(
    ...
    try:
        ...
        if request.use_rag:
            ...
            logging.info(f"Received {len(search_results_raw)} search results from R2R.")
